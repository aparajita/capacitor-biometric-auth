...
| If the array is empty, undefined is returned and the array is not modified. |
| **slice**                                                                   | (start?: number, end?: number) =&gt; T[]                                                                                      | Returns a copy of a section of an array.                                                                                                                                                                                                    | For both start and end, a negative index can be used to indicate an offset from the end of the array. |
